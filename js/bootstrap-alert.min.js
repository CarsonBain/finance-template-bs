$.bsAlert = {
  alertTitle: "Alert",
  confirmTitle: "Would you like to proceed?",
  closeDisplay: "Cancel",
  sureDisplay: "OK",
  isConfirm: false,
  init: function(w) {
  ...
  createConfirmWin: function(msg) {
    ...
    $h1 += "                <button type='button' class='btn btn-danger' data-dismiss='modal'>" + this.closeDisplay + "</button>";
    $h1 += "                <button type='button' id='bsSaveBtn' class='btn btn-success white'>" + this.sureDisplay + "</button>";
    $h1 += "            </div>";
    $h1 += "        </div>";
    $h1 += "    </div>";
    $h1 += "</div>";
